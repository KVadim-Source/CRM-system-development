...
class User(AbstractUser):
    ...
    Attributes:
        ...
        user_permissions (ManyToManyField): Разрешения, назначенные пользователю напрямую.
    """
    ...
    role: str = models.CharField(max_length=10, choices=ROLE_CHOICES, default='operator')
